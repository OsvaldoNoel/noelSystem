<div wire:ignore.self class="modal fade" id="addModalCaja" data-bs-keyboard="false" data-bs-backdrop="static" tabindex="-1"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                @include('livewire.tenant.config.cajas.modal_form')
            </div>
...
<div wire:ignore.self class="modal fade" id="editModalCaja" data-bs-keyboard="false" data-bs-backdrop="static" tabindex="-1"
...
@script
    <script>
        $wire.on('showAddModal', () => {
            $('#addModalCaja').modal('show');  
        });
        $wire.on('showEditModal', () => { 
            $('#editModalCaja').modal('show'); 
        });
        $wire.on('closeModal', () => {
            $('#addModalCaja').modal('hide');
            $('#editModalCaja').modal('hide');
            $wire.cancel();
        });
    </script>
@endscript
