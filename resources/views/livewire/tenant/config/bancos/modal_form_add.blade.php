<form wire:submit="save"> 
    ...
    <div class="row">
        <div class="form-group col-sm-6 mt-3">
            <label for="select-entidad_add" class="mb-0 text-muted">Entidad</label>

            <div wire:ignore>
                <div class="input-group">
                    <span class="input-group-text text-success"><Span class="fa fa-edit"></Span></span>
                    <select class="form-select text-theme" id="select-entidad_add" placeholder="Seleccione una opción"
                        autocomplete="off">
                    </select>
                </div>
            </div>
...
@script
    <script>
        $wire.$on('valorData', ($id) => {
            ...
            let newName = new TomSelect("#select-entidad_add", {
                create: false,
                items: $id[0],
                options: options,
                valueField: 'id',
