...
{
    public $selected_id, $username, $ci, $name, $lastname, $phone, $addres, $barrio, $city, $email; 
    ...
    {		
		$this->reset(['selected_id','username','ci','name','lastname','phone','email','addres','barrio','city']);
    }
    ...
    protected $messages = [
        ...
        'addres.required' => 'El telefono del Usuario es requerido', 
        'addres.min' => 'El telefono debe tener al menos 5 caracteres',
        'addres.max' => 'El telefono debe tener como maximo 100 caracteres',
